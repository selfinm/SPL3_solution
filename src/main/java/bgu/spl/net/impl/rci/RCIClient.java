...
public class RCIClient implements Closeable {
    ...
    private final Queue<Command<?>> queueSender;
    private final Queue<Command<?>> queueReceiver;
    ...
    public RCIClient(String host, int port) throws IOException {
        ...
        queueSender = new ConcurrentLinkedQueue<>();
        queueReceiver = new ConcurrentLinkedQueue<>();
